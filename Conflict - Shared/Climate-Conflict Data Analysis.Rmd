...
# same but for event rates per 1000 people
country_year %>% 
...
# ACLED events by north vs south, including Abidjan
north_year %>% 
  filter(year < 2021) %>% 
  ggplot(aes(x = year)) + 
...
# ACLED event rates by north vs south, including Abidjan
north_year %>% 
  filter(year < 2021) %>% 
  ggplot(aes(x = year)) + 
...
# ACLED events by north vs south, excluding Abidjan
...
# ACLED event rates by north vs south, excluding Abidjan
north_year_noabidjan %>% 
  filter(year < 2021) %>% 
  ggplot(aes(x = year)) + 
  geom_line(aes(y = events_p1000, group = north, color = factor(north))) +
...
# ACLED event subtype rates by North vs South, including Abidjan
north_year %>% 
...
```{r acled-maps-cross-section, include=FALSE, eval=FALSE}
...
# plot event rates per 1000 people
ggplot(data = region_events_sf) +
...
```{r acled-maps-annual, include=FALSE, eval=FALSE}
# join to region geometry
region_year_sf <- ci_regions %>% 
  left_join(region_year, by = "region_id")

# all ACLED events, counts and rates, alternate excluding Abidjan for counts
...
```{r climate-seasonality-north-south, include=FALSE, eval=FALSE}
# seasonality by North and South because different seasons
region_month %>% 
  left_join(north_key %>% dplyr::select(region_id, north), by = "region_id") %>% 
...
```{r climate-maps-cross-section, include=FALSE, eval=FALSE}
...
- Dependent variables: all ACLED events, protests & riots, battles & explosions, violence against civilians
  ...
  - also versions that group violence against civilians with battles/explosions
...
- Fixed effects and similar: region only, region and year, region FE with year as a control variable
  - main specification: region and year FE
- Lags: contemporaneous only, 0:1, 0:3
  - main specification: 0:1
...
# temp in levels/prcp in abs st dev units
absprcp_twoway_0to1 <- feols(
  c(events_count, events_p1000, protests_riots, protests_p1000,
    battles_explosions, battles_p1000, violence_civ_count, violciv_p1000) ~ 
...
levels_twoway_0to1_actors <- feols(
...
levels_twoway_0to3_actors <- feols(
  c(state_forces_count, state_p1000, nonstate_armed, nonstate_armed_p1000, 
    pol_militias_count, polmilitias_p1000, id_militias_count, idmilitias_p1000) ~ 
    # temperature in degrees Celsius and rainfall in mm per day, lags 0:3
    temp2m_c + temp2m_c_l1 + temp2m_c_l2 + temp2m_c_l3 + prcp_mm + prcp_mm_l1 + prcp_mm_l2 + prcp_mm_l3 | 
...
```{r latex-tables, echo=FALSE, results='asis'}
# DV counts vs rates, climate levels vs absolute precip, by event subtype
etable(
  levels_twoway_0to1$`Full sample`$protests_riots, 
  levels_twoway_0to1$`Full sample`$protests_p1000, 
  absprcp_twoway_0to1$`Full sample`$protests_riots, 
  absprcp_twoway_0to1$`Full sample`$protests_p1000, 
  tex = TRUE, 
...
etable(
  levels_twoway_0to1$`Full sample`$battles_explosions, 
  levels_twoway_0to1$`Full sample`$battles_p1000, 
  absprcp_twoway_0to1$`Full sample`$battles_explosions, 
  absprcp_twoway_0to1$`Full sample`$battles_p1000, 
  tex = TRUE, 
...
etable(
  levels_twoway_0to1$`Full sample`$violence_civ_count, 
  levels_twoway_0to1$`Full sample`$violciv_p1000, 
  absprcp_twoway_0to1$`Full sample`$violence_civ_count, 
  absprcp_twoway_0to1$`Full sample`$violciv_p1000, 
  tex = TRUE, 
...
etable(
  levels_twoway_0to1$`Full sample`$protests_riots, 
  levels_twoway_0to1$`0`$protests_riots, 
  levels_twoway_0to1$`1`$protests_riots, 
  levels_twoway_0to1$`Full sample`$protests_p1000, 
  levels_twoway_0to1$`0`$protests_p1000, 
  levels_twoway_0to1$`1`$protests_p1000, 
  tex = TRUE, 
  title = "Protests and Riots", 
...
etable(
  levels_twoway_0to1$`Full sample`$battles_explosions, 
  levels_twoway_0to1$`0`$battles_explosions, 
  levels_twoway_0to1$`1`$battles_explosions, 
  levels_twoway_0to1$`Full sample`$battles_p1000, 
  levels_twoway_0to1$`0`$battles_p1000, 
  levels_twoway_0to1$`1`$battles_p1000, 
  tex = TRUE, 
  title = "Battles and Explosions", 
  subtitles = c("Full Sample", "South", "North", "Full Sample", "South", "North"), 
  dict = c(
...
etable(
  levels_twoway_0to1$`Full sample`$violence_civ_count, 
  levels_twoway_0to1$`0`$violence_civ_count, 
  levels_twoway_0to1$`1`$violence_civ_count, 
  levels_twoway_0to1$`Full sample`$violciv_p1000, 
  levels_twoway_0to1$`0`$violciv_p1000, 
  levels_twoway_0to1$`1`$violciv_p1000, 
  tex = TRUE, 
  title = "Violence Against Civilians", 
  subtitles = c("Full Sample", "South", "North", "Full Sample", "South", "North"), 
  dict = c(
...
etable(
  levels_twoway_0to3$`Full sample`$protests_riots, 
  levels_twoway_0to3$`Full sample`$protests_p1000, 
  absprcp_twoway_0to3$`Full sample`$protests_riots, 
  absprcp_twoway_0to3$`Full sample`$protests_p1000, 
  tex = TRUE, 
  title = "Protests and Riots", 
  dict = c(
    protests_riots = "Event Count", 
...
etable(
  levels_twoway_0to3$`Full sample`$battles_explosions, 
  levels_twoway_0to3$`Full sample`$battles_p1000, 
  absprcp_twoway_0to3$`Full sample`$battles_explosions, 
  absprcp_twoway_0to3$`Full sample`$battles_p1000, 
  tex = TRUE, 
  title = "Battles and Explosions", 
  dict = c(
    battles_explosions = "Event Count", 
...
etable(
  levels_twoway_0to3$`Full sample`$violence_civ_count, 
  levels_twoway_0to3$`Full sample`$violciv_p1000, 
  absprcp_twoway_0to3$`Full sample`$violence_civ_count, 
  absprcp_twoway_0to3$`Full sample`$violciv_p1000, 
  tex = TRUE, 
  title = "Violence Against Civilians", 
  dict = c(
    violence_civ_count = "Event Count", 
...
# rates per 1000 people, violence against civilians separate
etable(
  levels_twoway_0to1$`Full sample`$events_p1000, 
  levels_twoway_0to1$`Full sample`$protests_p1000, 
  levels_twoway_0to1$`Full sample`$battles_p1000, 
  levels_twoway_0to1$`Full sample`$violciv_p1000, 
  tex = TRUE, 
  title = "ACLED Event Rates Per 1000 People", 
  dict = c(
    events_p1000 = "All events", 
    protests_p1000 = "Protests & riots", 
    battles_p1000 = "Battles & explosions", 
    violciv_p1000 = "Violence against civilians",
    temp2m_c = "Temperature", 
    temp2m_c_l1 = "Temperature: 1-year lag", 
    prcp_mm = "Rainfall", 
    prcp_mm_l1 = "Rainfall: 1-year lag", 
    region_id = "Region", 
    year = "Year"
  ), 
  notes = "Temperature is averaged degrees Celsius; rainfall is averaged millimeters per day."
)

# rates per 1000 people, violence against civilians grouped with battles/explosions
etable(
  levels_twoway_0to1$`Full sample`$events_p1000, 
  levels_twoway_0to1$`Full sample`$protests_p1000, 
  levels_twoway_0to1$`Full sample`$battlesattacks_p1000, 
  tex = TRUE, 
  title = "ACLED Event Rates Per 1000 People", 
  dict = c(
    events_p1000 = "All events", 
    protests_p1000 = "Protests & riots", 
    battlesattacks_p1000 = "Battles, explosions, & viol. civ.", 
    temp2m_c = "Temperature", 
    temp2m_c_l1 = "Temperature: 1-year lag", 
    prcp_mm = "Rainfall", 
    prcp_mm_l1 = "Rainfall: 1-year lag", 
...
# incidence, violence against civilians separate
etable(
  ...
  tex = TRUE, 
  title = "Probability of Any ACLED Event", 
  dict = c(
    events_any = "All events", 
    protests_any = "Protests & riots", 
    battles_any = "Battles & explosions", 
    violciv_any = "Violence against civilians",
    temp2m_c = "Temperature", 
    temp2m_c_l1 = "Temperature: 1-year lag", 
    prcp_mm = "Rainfall", 
    prcp_mm_l1 = "Rainfall: 1-year lag", 
...
# incidence, violence against civilians grouped with battles/explosions
etable(
  levels_twoway_0to1_lpm$`Full sample`$events_any, 
  levels_twoway_0to1_lpm$`Full sample`$protests_any, 
  levels_twoway_0to1_lpm$`Full sample`$battlesattacks_any, 
  tex = TRUE, 
  title = "Probability of Any ACLED Event", 
  dict = c(
    events_any = "All events", 
    protests_any = "Protests & riots", 
    battlesattacks_any = "Battles, explosions, & viol. civ.", 
    temp2m_c = "Temperature", 
    temp2m_c_l1 = "Temperature: 1-year lag", 
    prcp_mm = "Rainfall", 
    prcp_mm_l1 = "Rainfall: 1-year lag", 
...
```{r coefplot-tidy-function, include=FALSE}
extract_estimates <- function(modelname, outputname) {
  
  depvars <- names(modelname)
  
  outputname_list <- list()
  
  for (i in seq_along(depvars)) {
    outputname_list[[i]] <- tidy(
      modelname[[i]], 
      conf.int = TRUE
      )
    names(outputname_list)[[i]] <- depvars[[i]]
    outputname_list[[i]]$depvar <- depvars[[i]]
  }
  
  outputname_tidy <- bind_rows(outputname_list)
  
  return(outputname_tidy)
  
}
```

```{r coefplot-rates, include=FALSE}
# tidy estimates in preparation for plotting
mainspec_tidy <- extract_estimates(levels_twoway_0to1$`Full sample`, mainspec)
mainspec_tidy <- mainspec_tidy %>% 
  filter(
    depvar == "events_p1000" | depvar == "protests_p1000" | 
      depvar == "battlesattacks_p1000" | depvar == "battles_p1000" | 
      depvar == "violciv_p1000"
    ) %>% 
  mutate(
    xvar = factor(
      term, 
...
# plot with violence against civilians separate
ggplot(
  mainspec_tidy %>% filter(depvar != "battlesattacks_p1000"), 
...
# plot with violence against civilians grouped with battles/explosions
ggplot(
  mainspec_tidy %>% filter(depvar != "battles_p1000" & depvar != "violciv_p1000"), 
  aes(x = xvar, y = estimate, group = yvar, color = yvar)
  ) +
  geom_hline(yintercept = 0, size = 0.15) +
  geom_point(position = position_dodge(width = 0.5)) +
...
```{r coefplot-incidence, include=FALSE}
# tidy estimates in preparation for plotting
lpm_tidy <- extract_estimates(levels_twoway_0to1_lpm$`Full sample`, lpm)
lpm_tidy <- lpm_tidy %>% 
  filter(
    depvar == "events_any" | depvar == "protests_any" | 
      depvar == "battlesattacks_any" | depvar == "battles_any" | 
      depvar == "violciv_any"
    ) %>% 
  mutate(
    xvar = factor(
