...
```{r region-year-import, echo = FALSE}
...
```{r collapse-to-country-year, eval=FALSE}
...
```{r climate-trends-country-year, eval=FALSE}
...
```{r acled-trends-country-year, eval=FALSE}
...
```{r acled-subtype-trends-country-year, eval=FALSE}
...
```{r climate-seasonality-country-month, eval=FALSE}
...
```{r acled-trends-north-south, eval=FALSE}
...
```{r acled-map-recent-events, eval=FALSE}
...
```{r visualize-estimates, results='asis'}
